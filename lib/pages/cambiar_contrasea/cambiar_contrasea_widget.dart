...
class CambiarContraseaWidget extends StatefulWidget {
  const CambiarContraseaWidget({Key? key}) : super(key: key);

  @override
  _CambiarContraseaWidgetState createState() => _CambiarContraseaWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFCD7BFB),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Enviaremos un correo electronico para verificacion y podra cambiar su contraseña',
