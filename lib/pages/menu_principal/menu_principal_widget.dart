...
import '/componentes/chatbot/chatbot_widget.dart';
...
class _MenuPrincipalWidgetState extends State<MenuPrincipalWidget> {
  ...
  late List<FacturaDto> ultimasFacturas = [];
  ...
  void initState() {
    ...
    try {
      Future<ApiCallResponse> facturas =
          GenerarFacturaCall.obtenerUltimas3Facturas(
              idCliente: FFAppState().idCliente);
      facturas.then((value) {
        ultimasFacturas = facturaDtoFromJson(json.encode(value.jsonBody));
      });
    } catch (e) {
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Image.network(
                              'https://images.unsplash.com/photo-1633332755192-727a05c4013d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHx1c2VyfGVufDB8fHx8MTY5MzQ1OTI2Mnww&ixlib=rb-4.0.3&q=80&w=1080',
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                              ...
                              children: [
                                  ...
                                  child: ClipRRect(
                                    child: Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed('ProducyServi');
                                        },
                                        child: Column(
                                ...
                                Material(
                                  ...
                                  child: ClipRRect(
                                    child: InkWell(
                                      onTap: () async {
                                          context.pushNamed('menuReportes');
                                        },
                                      child: Container(
                                        width: 100.0,
                                        height: 100.0,
                                                ...
                                                child: Padding(
                                                  padding:
                                                      MediaQuery.viewInsetsOf(
                                                          context),
                                                  child:
                                                      ChatbotWidget(), //gfdbdsbgfsbgfsbfnsfsnsnns//
                                                ),
                                              );
                                            },
                                          ).then((value) => setState(() {}));
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          20.0, 30.0, 0.0, 0.0),
                                      child: Text(
                                        'Facturas Emitídas Recientemente:',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: ultimasFacturas.length,
                                itemBuilder:
                                    (BuildContext context, int index) {
                                  FacturaDto fact =
                                      ultimasFacturas[index];
