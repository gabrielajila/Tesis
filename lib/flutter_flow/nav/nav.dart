...
import 'package:facturito/componentes/register_new_user/register.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        FFRoute(
          name: '_facturasEmitidas',
          path: '/facturasEmitidas',
          builder: (context, _) => FacturasEmitidas(),
        ),
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Registrar',
          path: '/registrar',
          builder: (context, params) => RegisterWidget(), // RegistrarWidget(),
        ),
        FFRoute(
          name: 'MenuPrincipal',
          path: '/menuPrincipal',
        ...
        FFRoute(
          name: 'ProducyServi',
          path: '/producyServi',
          builder: (context, params) => ProductoPage(),
        ),
        FFRoute(
          name: 'Clientes',
          path: '/clientes',
        ...
        FFRoute(
          name: 'Facturar',
          path: '/facturar',
          builder: (context, params) => GenerafacturaWidget(),
        ),
        FFRoute(
          name: 'FacturaEmitida',
          path: '/facturaEmitida',
          builder: (context, params) => FacturaEmitidaWidget(),
        ),
        FFRoute(
          name: 'cambiarContrasea',
          path: '/cambiarContrasea',
          builder: (context, params) => CambiarContraseaWidget(),
        ),
        FFRoute(
          name: 'menuReportes',
          path: '/menuReportes',
        ...
        FFRoute(
          name: 'FactProducto',
          path: '/factProducto',
          builder: (context, params) => FactProductoWidget(),
        )
